...
const Success = () => {
  return (
    <div className='orderSuccess flex flex-col items-center justify-center h-screen gap-5'>
      ...
      <Link to ="/order/me" className='bg-orange-500 text-white px-3 py-1 rounded border hover:bg-white hover:text-orange-500 hover:border-orange-500'>View Orders</Link>
    </div>
  )
}
