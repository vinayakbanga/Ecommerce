  ...
  return (
    ...
    <div className=' md:w-1/4  md:border-r-2'>
      <Sidebar/>
        ...
        <div className="productReviewsContainer md:w-3/4">
          <form
            className="productReviewsForm mt-5 flex flex-col items-center px-2 gap-5 justify-center h-1/2 transition-all"
